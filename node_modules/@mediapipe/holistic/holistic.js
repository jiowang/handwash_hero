...
*/
'use strict';function aa(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}}function v(a){var b="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];return b?b.call(a):{next:aa(a)}}function w(a){if(!(a instanceof Array)){a=v(a);for(var b,c=[];!(b=a.next()).done;)c.push(b.value);a=c}return a}var z="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(a==Array.prototype||a==Object.prototype)return a;a[b]=c.value;return a};
function ba(a){a=["object"==typeof globalThis&&globalThis,a,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var b=0;b<a.length;++b){var c=a[b];if(c&&c.Math==Math)return c}throw Error("Cannot find global object");}var A=ba(this);function D(a,b){if(b)a:{var c=A;a=a.split(".");for(var d=0;d<a.length-1;d++){var f=a[d];if(!(f in c))break a;c=c[f]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&z(c,a,{configurable:!0,writable:!0,value:b})}}var E;
if("function"==typeof Object.setPrototypeOf)E=Object.setPrototypeOf;else{var F;a:{var ea={a:!0},fa={};try{fa.__proto__=ea;F=fa.a;break a}catch(a){}F=!1}E=F?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var ha=E;function J(){this.l=!1;this.h=null;this.j=void 0;this.g=1;this.s=this.m=0;this.i=null}function O(a){if(a.l)throw new TypeError("Generator is already running");a.l=!0}J.prototype.o=function(a){this.j=a};
function ia(a,b){a.i={J:b,K:!0};a.g=a.m||a.s}J.prototype.return=function(a){this.i={return:a};this.g=this.s};function P(a,b,c){a.g=c;return{value:b}}function ja(a){this.g=new J;this.h=a}function ka(a,b){O(a.g);var c=a.g.h;if(c)return la(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.g.return);a.g.return(b);return Q(a)}
function la(a,b,c,d){try{var f=b.call(a.g.h,c);if(!(f instanceof Object))throw new TypeError("Iterator result "+f+" is not an object");if(!f.done)return a.g.l=!1,f;var k=f.value}catch(e){return a.g.h=null,ia(a.g,e),Q(a)}a.g.h=null;d.call(a.g,k);return Q(a)}function Q(a){for(;a.g.g;)try{var b=a.h(a.g);if(b)return a.g.l=!1,{value:b.value,done:!1}}catch(c){a.g.j=void 0,ia(a.g,c)}a.g.l=!1;if(a.g.i){b=a.g.i;a.g.i=null;if(b.K)throw b.J;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
function ma(a){this.next=function(b){O(a.g);a.g.h?b=la(a,a.g.h.next,b,a.g.o):(a.g.o(b),b=Q(a));return b};this.throw=function(b){O(a.g);a.g.h?b=la(a,a.g.h["throw"],b,a.g.o):(ia(a.g,b),b=Q(a));return b};this.return=function(b){return ka(a,b)};this[Symbol.iterator]=function(){return this}}function V(a,b){b=new ma(new ja(b));ha&&a.prototype&&ha(b,a.prototype);return b}
D("Symbol",function(a){function b(f){if(this instanceof b)throw new TypeError("Symbol is not a constructor");return new c("jscomp_symbol_"+(f||"")+"_"+d++,f)}function c(f,k){this.g=f;z(this,"description",{configurable:!0,writable:!0,value:k})}if(a)return a;c.prototype.toString=function(){return this.g};var d=0;return b});
...
var oa="function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(d)for(var f in d)Object.prototype.hasOwnProperty.call(d,f)&&(a[f]=d[f])}return a};D("Object.assign",function(a){return a||oa});
D("Promise",function(a){function b(e){this.h=0;this.i=void 0;this.g=[];this.o=!1;var g=this.j();try{e(g.resolve,g.reject)}catch(h){g.reject(h)}}function c(){this.g=null}function d(e){return e instanceof b?e:new b(function(g){g(e)})}if(a)return a;c.prototype.h=function(e){if(null==this.g){this.g=[];var g=this;this.i(function(){g.l()})}this.g.push(e)};var f=A.setTimeout;c.prototype.i=function(e){f(e,0)};c.prototype.l=function(){for(;this.g&&this.g.length;){var e=this.g;this.g=[];for(var g=0;g<e.length;++g){var h=
...
b.prototype.A=function(e){var g=void 0;try{g=e.then}catch(h){this.l(h);return}"function"==typeof g?this.I(g,e):this.m(e)};b.prototype.l=function(e){this.s(2,e)};b.prototype.m=function(e){this.s(1,e)};b.prototype.s=function(e,g){if(0!=this.h)throw Error("Cannot settle("+e+", "+g+"): Promise already settled in state"+this.h);this.h=e;this.i=g;2===this.h&&this.G();this.D()};b.prototype.G=function(){var e=this;f(function(){if(e.F()){var g=A.console;"undefined"!==typeof g&&g.error(e.i)}},1)};b.prototype.F=
...
function pa(a,b){a instanceof String&&(a+="");var c=0,d=!1,f={next:function(){if(!d&&c<a.length){var k=c++;return{value:b(k,a[k]),done:!1}}d=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f}D("Array.prototype.keys",function(a){return a?a:function(){return pa(this,function(b){return b})}});var qa=this||self;
function W(a,b){a=a.split(".");var c=qa;a[0]in c||"undefined"==typeof c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)a.length||void 0===b?c[d]&&c[d]!==Object.prototype[d]?c=c[d]:c=c[d]={}:c[d]=b};function X(a,b){var c=void 0;return new (c||(c=Promise))(function(d,f){function k(h){try{g(b.next(h))}catch(l){f(l)}}function e(h){try{g(b["throw"](h))}catch(l){f(l)}}function g(h){h.done?d(h.value):(new c(function(l){l(h.value)})).then(k,e)}g((b=b.apply(a,void 0)).next())})};var ra=[[61,146],[146,91],[91,181],[181,84],[84,17],[17,314],[314,405],[405,321],[321,375],[375,291],[61,185],[185,40],[40,39],[39,37],[37,0],[0,267],[267,269],[269,270],[270,409],[409,291],[78,95],[95,88],[88,178],[178,87],[87,14],[14,317],[317,402],[402,318],[318,324],[324,308],[78,191],[191,80],[80,81],[81,82],[82,13],[13,312],[312,311],[311,310],[310,415],[415,308]],sa=[[263,249],[249,390],[390,373],[373,374],[374,380],[380,381],[381,382],[382,362],[263,466],[466,388],[388,387],[387,386],[386,
385],[385,384],[384,398],[398,362]],ua=[[276,283],[283,282],[282,295],[295,285],[300,293],[293,334],[334,296],[296,336]],va=[[33,7],[7,163],[163,144],[144,145],[145,153],[153,154],[154,155],[155,133],[33,246],[246,161],[161,160],[160,159],[159,158],[158,157],[157,173],[173,133]],wa=[[46,53],[53,52],[52,65],[65,55],[70,63],[63,105],[105,66],[66,107]],xa=[[10,338],[338,297],[297,332],[332,284],[284,251],[251,389],[389,356],[356,454],[454,323],[323,361],[361,288],[288,397],[397,365],[365,379],[379,378],
[378,400],[400,377],[377,152],[152,148],[148,176],[176,149],[149,150],[150,136],[136,172],[172,58],[58,132],[132,93],[93,234],[234,127],[127,162],[162,21],[21,54],[54,103],[103,67],[67,109],[109,10]],ya=[].concat(w(ra),w(sa),w(ua),w(va),w(wa),w(xa));function za(a,b,c){c=a.createShader(0===c?a.VERTEX_SHADER:a.FRAGMENT_SHADER);a.shaderSource(c,b);a.compileShader(c);if(!a.getShaderParameter(c,a.COMPILE_STATUS))throw Error("Could not compile WebGL shader.\n\n"+a.getShaderInfoLog(c));return c};function Aa(a,b){this.h=a;this.j=b;this.i=0};var Ba=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,2,1,0,10,9,1,7,0,65,0,253,15,26,11]);function Ca(a,b){return b+a}function Da(a,b){window[a]=b}function Ea(a){var b=document.createElement("script");b.setAttribute("src",a);b.setAttribute("crossorigin","anonymous");document.body.appendChild(b);return new Promise(function(c){b.addEventListener("load",function(){c()},!1)})}
function Fa(a){for(var b=[],c=a.size(),d=0;d<c;++d){var f=a.get(d);b.push({x:f.x,y:f.y,visibility:f.hasVisibility?f.visibility:void 0})}return b}function Ga(a,b,c){this.graph=a;this.locateFile=b;this.g=c}Ga.prototype.toArrayBuffer=function(){return X(this,function b(){var c=this,d;return V(b,function(f){return 1==f.g?(c.graph.url?f=P(f,fetch(c.locateFile(c.graph.url,c.g)),3):(f.g=2,f=void 0),f):2!=f.g&&(d=f.j,d.body)?f.return(d.arrayBuffer()):f.return(new ArrayBuffer(0))})})};
function Ha(){return X(this,function b(){return V(b,function(c){switch(c.g){case 1:return c.m=2,P(c,WebAssembly.instantiate(Ba),4);case 4:c.g=3;c.m=0;break;case 2:return c.m=0,c.i=null,c.return(!1);case 3:return c.return(!0)}})})}
function Y(a){this.h=a;this.listeners={};this.s={};this.B={};this.l=this.A=!0;this.o=Promise.resolve();this.locateFile=a&&a.locateFile||Ca;if("object"===typeof window)a=window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/";else if("undefined"!==typeof location)a=location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/";else throw Error("solutions can only be loaded on a web page or in a web worker");this.F=a}
Y.prototype.close=function(){this.i&&this.i.delete();return Promise.resolve()};
function Ia(a){return X(a,function c(){var d=this,f,k,e,g,h,l,m,t,r;return V(c,function(n){switch(n.g){case 1:f=d;if(!d.A)return n.return();Da("createMediapipeSolutionsWasm",{locateFile:d.locateFile});Da("createMediapipeSolutionsPackedAssets",{locateFile:d.locateFile});k=d.h.files||[];return P(n,Ha(),2);case 2:return e=n.j,P(n,Promise.all(k.map(function(q){return void 0===q.simd||q.simd&&e||!q.simd&&!e?Ea(f.locateFile(q.url,f.F)):Promise.resolve()})),3);case 3:return g=window.createMediapipeSolutionsWasm,
h=window.createMediapipeSolutionsPackedAssets,P(n,g(h),4);case 4:return d.g=n.j,d.j=document.createElement("canvas"),d.g.canvas=d.j,d.g.createContext(d.j,!0,!0,{}),d.i=new d.g.SolutionWasm,l=new Ga(d.h.graph,d.locateFile,d.F),P(n,d.loadGraph(l),5);case 5:if(d.h.listeners)for(m=v(d.h.listeners),t=m.next();!t.done;t=m.next())r=t.value,Ja(d,r);d.A=!1;n.g=0}})})}
...
function Ka(a){return X(a,function c(){var d=this,f,k,e,g,h;return V(c,function(l){if(!d.l)return l.return();f=d.j.getContext("webgl2");if(!f)return alert("Failed to create WebGL canvas context when passing video frame."),l.return();d.D=f;if(d.m){k=new d.g.GraphOptionChangeRequestList;e=v(d.m);for(g=e.next();!g.done;g=e.next())h=g.value,k.push_back(h);d.i.changeOptions(k);k.delete();d.m=void 0}d.l=!1;l.g=0})})}
Y.prototype.initialize=function(){return X(this,function b(){var c=this;return V(b,function(d){return 1==d.g?P(d,Ia(c),2):P(d,Ka(c),0)})})};Y.prototype.loadGraph=function(a){return X(this,function c(){var d,f=this;return V(c,function(k){if(1==k.g)return P(k,a.toArrayBuffer(),2);d=k.j;f.i.loadGraph(d);k.g=0})})};
Y.prototype.send=function(a,b){return X(this,function d(){var f=this,k,e,g,h,l,m,t,r;return V(d,function(n){if(1==n.g){if(!f.h.inputs)return n.return();k=1E3*(b||performance.now());return P(n,f.o,2)}if(3!=n.g)return P(n,f.initialize(),3);e=new f.g.PacketDataList;g=v(Object.keys(a));for(h=g.next();!h.done;h=g.next())if(l=h.value,m=f.h.inputs[l]){a:{var q=a[l];switch(m.type){case "video":var p=f.s[m.stream];p||(p=new Aa(f.g,f.D),f.s[m.stream]=p);0===p.i&&(p.i=p.h.createTexture());if(q instanceof HTMLVideoElement){var u=
q.videoWidth;var B=q.videoHeight}else q instanceof HTMLImageElement?(u=q.naturalWidth,B=q.naturalHeight):(u=q.width,B=q.height);B={glName:p.i,width:u,height:B};u=p.j;u.canvas.width=B.width;u.canvas.height=B.height;u.activeTexture(u.TEXTURE0);p.h.bindTexture2d(p.i);u.texImage2D(u.TEXTURE_2D,0,u.RGBA,u.RGBA,u.UNSIGNED_BYTE,q);p.h.bindTexture2d(0);p=B;break a;default:p={}}}t=p;r=m.stream;e.pushTexture2d(Object.assign(Object.assign({},t),{stream:r,timestamp:k}))}f.i.send(e);e.delete();n.g=0})})};
function La(a,b,c){if(c.isNumber())return c.getNumber();if(c.isRect())return c.getRect();if(c.isLandmarks())return c.getLandmarks();if(c.isLandmarksList())return c.getLandmarksList();if(c.isClassificationsList())return c.getClassificationsList();if(c.isObjectDetectionList())return c.getObjectDetectionList();if(c.isTexture2d()){var d=a.B[b];d||(d=new Aa(a.g,a.D),a.B[b]=d);a=d;c=c.getTexture2d();b=a.j;if(void 0===a.l){d=za(b,"\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }",
0);var f=za(b,"\n  precision highp float;\n  varying vec2 vTex;\n  uniform sampler2D sampler0;\n  void main(){\n    gl_FragColor = texture2D(sampler0, vTex);\n  }",1),k=b.createProgram();b.attachShader(k,d);b.attachShader(k,f);b.linkProgram(k);if(!b.getProgramParameter(k,b.LINK_STATUS))throw Error("Could not compile WebGL program.\n\n"+b.getProgramInfoLog(k));d=a.l=k;b.useProgram(d);f=b.getUniformLocation(d,"sampler0");a.g={v:b.getAttribLocation(d,"aVertex"),u:b.getAttribLocation(d,"aTex"),W:f};a.o=
...
function Ja(a,b){for(var c=b.name||"$",d=[].concat(w(b.wants)),f=new a.g.StringList,k=v(b.wants),e=k.next();!e.done;e=k.next())f.push_back(e.value);k=a.g.PacketListener.implement({onResults:function(g){return X(a,function l(){var m,t,r=this,n,q;return V(l,function(p){if(1==p.g){m={};for(t=0;t<b.wants.length;++t)m[d[t]]=La(r,b.wants[t],g.get(t));if(b.outs){for(var u=m,B=b.outs,G={},ta=v(Object.keys(B)),x=ta.next();!x.done;x=ta.next()){x=x.value;var C=B[x];if("string"===typeof C)G[x]=u[C];else{var H=
u[C.stream];if(void 0!==H){if("landmarks"===C.type)G[x]=Fa(H);else if("landmarks_list"===C.type){for(var I=[],R=H.size(),y=0;y<R;++y){var K=H.get(y);I.push(Fa(K))}G[x]=I}else if("classifications_list"===C.type){I=[];R=H.size();for(y=0;y<R;++y){var M=H.get(y);K=I;for(var ca=K.push,T=[],U=M.size(),N=0;N<U;++N){var S=M.get(N);T.push({index:S.index,score:S.score,label:S.label})}ca.call(K,T)}G[x]=I}else if("object_detection_list"===C.type){I=[];R=H.size();for(y=0;y<R;++y){M=H.get(y);K=I;ca=K.push;T=M.id;
U=M.keypoints;N=[];S=U.size();for(var da=0;da<S;++da){var L=U.get(da);N.push({id:L.id,point3d:{x:L.point3d.x,y:L.point3d.y,z:L.point3d.z},point2d:{x:L.point2d.x,y:L.point2d.y,depth:L.point2d.depth}})}ca.call(K,{id:T,keypoints:N,visibility:M.visibility})}G[x]=I}else throw Error("Unknown output config type: '"+C.type+"'");C.transform&&(G[x]=C.transform(G[x]))}}}m=G}(n=r.listeners[c])?p=P(p,r.o,3):(p.g=0,p=void 0);return p}if(q=n(m))return r.o=q,p.return(q);p.g=0})})}});a.i.attachMultiListener(f,k);
...
fieldName:"threshold"}}}})}Z.prototype.close=function(){this.g.close();return Promise.resolve()};Z.prototype.onResults=function(a){this.g.onResults(a)};Z.prototype.initialize=function(){return X(this,function b(){var c=this;return V(b,function(d){return P(d,c.g.initialize(),0)})})};Z.prototype.send=function(a){return X(this,function c(){var d=this;return V(c,function(f){return P(f,d.g.send(a),0)})})};Z.prototype.setOptions=function(a){this.g.setOptions(a)};W("Holistic",Z);W("FACEMESH_LIPS",ra);
W("FACEMESH_LEFT_EYE",sa);W("FACEMESH_LEFT_EYEBROW",ua);W("FACEMESH_RIGHT_EYE",va);W("FACEMESH_RIGHT_EYEBROW",wa);W("FACEMESH_FACE_OVAL",xa);W("FACEMESH_CONTOURS",ya);
...
W("POSE_CONNECTIONS",[[0,1],[1,2],[2,3],[3,7],[0,4],[4,5],[5,6],[6,8],[9,10],[11,12],[11,13],[13,15],[15,17],[15,19],[15,21],[17,19],[12,14],[14,16],[16,18],[16,20],[16,22],[18,20],[11,23],[12,24],[23,24],[23,25],[24,26],[25,27],[26,28],[27,29],[28,30],[29,31],[30,32],[27,31],[28,32]]);
W("POSE_LANDMARKS",{NOSE:0,LEFT_EYE_INNER:1,LEFT_EYE:2,LEFT_EYE_OUTER:3,RIGHT_EYE_INNER:4,RIGHT_EYE:5,RIGHT_EYE_OUTER:6,LEFT_EAR:7,RIGHT_EAR:8,P:9,V:10,LEFT_SHOULDER:11,RIGHT_SHOULDER:12,LEFT_ELBOW:13,RIGHT_ELBOW:14,LEFT_WRIST:15,RIGHT_WRIST:16,LEFT_PINKY:17,RIGHT_PINKY:18,LEFT_INDEX:19,RIGHT_INDEX:20,LEFT_THUMB:21,RIGHT_THUMB:22,LEFT_HIP:23,RIGHT_HIP:24,O:25,U:26,L:27,R:28,N:29,T:30,M:31,S:32});}).call(this);
